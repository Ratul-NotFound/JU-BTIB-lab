  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-6 sm:py-16 space-y-6 sm:space-y-12">
      ...
      <section className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-[var(--border)] bg-[var(--surface)] shadow-md">
        ...
        <div className="relative w-full h-56 sm:h-96 lg:h-[480px] bg-[var(--surface-raised)]">
          ...
          <div className="absolute bottom-0 inset-x-0 p-4 sm:p-10 lg:p-12 space-y-2.5 sm:space-y-4 max-w-4xl text-white">
            ...
            {/* Title */}
            <h1 className="text-xl sm:text-4xl lg:text-5xl font-black font-sans tracking-tight text-white leading-tight">
              {activity.title}
            </h1>
          </div>
        </div>
      ...
      <section className="p-4 sm:p-8 lg:p-12 rounded-2xl sm:rounded-3xl border border-[var(--border)] bg-[var(--surface)] shadow-xs space-y-4 sm:space-y-6">
        ...
        {activity.bodyHtml ? (
          <div
            className="prose dark:prose-invert max-w-none text-sm sm:text-base text-[var(--text-secondary)] leading-relaxed font-light"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-6">
                  {album.images.map((img) => (
                    ...
                    >
                      ...
                      {img.caption && (
                        <p className="text-[10px] sm:text-xs text-[var(--text-muted)] px-1 leading-snug line-clamp-2">
                          {img.caption}
                        </p>
                      )}
                    </div>
