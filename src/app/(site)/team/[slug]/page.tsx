  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 space-y-12">
        ...
        {/* Profile Card Header */}
        <section className="p-8 sm:p-12 rounded-2xl border border-[var(--border)] bg-[var(--surface)] space-y-8 shadow-xs">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-xl border border-[var(--border)] bg-[var(--surface-raised)] flex items-center justify-center text-3xl font-serif font-bold text-[var(--bio-teal)] shrink-0 shadow-inner">
              {member.name
                .split(" ")
                .map((n) => n[0])
                .join("")
            ...
            <div className="space-y-1.5">
              <div className="flex flex-wrap items-center gap-2">
                <span className="px-2.5 py-0.5 rounded text-[11px] font-mono font-medium border border-[var(--border)] bg-[var(--surface-raised)] text-[var(--bio-teal)]">
                  {member.category}
                </span>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-[var(--border)]">
            {member.email && (
              <a
                ...
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-mono border border-[var(--border)] bg-[var(--surface-raised)] text-[var(--text-primary)] hover:border-[var(--bio-teal)] hover:text-[var(--bio-teal)] transition-colors"
              >
