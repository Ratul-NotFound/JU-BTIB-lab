  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 space-y-16">
        ...
        <section className="p-8 sm:p-12 rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-xs">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            
            <div className="lg:col-span-7 space-y-6">
              {/* Institutional Dual Badge */}
              <div className="flex items-center gap-3 w-fit p-1.5 pr-4 rounded-full border border-[var(--border)] bg-[var(--surface-raised)]/70">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3 text-xs font-mono text-[var(--text-muted)]">
                <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl border border-[var(--border)] bg-[var(--surface-raised)]">
            ...
            <div className="lg:col-span-5 relative aspect-[4/3] rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--surface-raised)] shadow-xs">
              <Image
              ...
              <div className="absolute bottom-4 left-4 right-4 text-xs text-white bg-black/65 backdrop-blur-md px-4 py-3 rounded-xl border border-white/15">
                <span className="font-bold block text-sm">BTIB Pilot Bioprocessing Suite</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ACHIEVEMENTS.map((ach) => {
              ...
              return (
                <div
                  key={ach.label}
                  className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--surface)] space-y-3 shadow-xs hover:border-[var(--brand-primary)] transition-all"
                >
                  <div className="flex items-center justify-between">
                    <div className="text-3xl sm:text-4xl font-extrabold text-[var(--brand-primary)] font-sans tracking-tight">
                      {ach.metric}
                    </div>
                    <div className="p-2.5 rounded-xl bg-[var(--brand-primary)]/10 text-[var(--brand-primary)]">
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-24">
              <div className="p-8 rounded-2xl border border-[var(--border)] bg-[var(--surface)] space-y-5 shadow-xs">
                ...
                <div className="pt-4 border-t border-[var(--border)] flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full border border-[var(--border)] bg-[var(--surface-raised)] flex items-center justify-center font-serif font-bold text-[var(--brand-primary)] shrink-0">
                    SR
                  </div>
            ...
            <div className="lg:col-span-7 space-y-4">
              {MILESTONES.map((m, idx) => (
                <div
                  key={m.year}
                  className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--surface)] hover:border-[var(--brand-primary)] transition-all shadow-xs space-y-2.5"
                >
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div className="flex items-center gap-3">
                      <span className="text-xl font-bold font-sans text-[var(--brand-primary)]">
                        {m.year}
                      </span>
                      <span className="px-2.5 py-0.5 rounded-md text-xs font-mono font-medium border border-[var(--border)] bg-[var(--surface-raised)] text-[var(--text-muted)]">
                        {m.tag}
                      </span>
                    </div>
                  ...
                  <h4 className="text-base sm:text-lg font-bold font-sans text-[var(--text-primary)]">
                    {m.title}
                  </h4>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 rounded-2xl border border-[var(--border)] bg-[var(--surface)] space-y-4 shadow-xs">
              <div className="p-3 rounded-xl bg-[var(--brand-primary)]/10 text-[var(--brand-primary)] w-fit">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {CORE_FACILITIES.map((facility) => {
              ...
              return (
                <div
                  key={facility.title}
                  className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--surface)] space-y-3 shadow-xs"
                >
                  <div className="p-2.5 rounded-xl bg-[var(--brand-primary)]/10 border border-[var(--border)] text-[var(--brand-primary)] w-fit">
                    <Icon className="w-5 h-5" />
                  </div>
        ...
        {pi && (
          <section className="p-8 sm:p-12 rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-xs space-y-8">
            <div className="border-b border-[var(--border)] pb-3">
              <h2 className="text-2xl sm:text-3xl font-bold font-sans text-[var(--text-primary)]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              <div className="lg:col-span-4 flex flex-col items-center sm:items-start text-center sm:text-left space-y-4">
                <div className="relative w-44 h-44 sm:w-52 sm:h-52 rounded-2xl border border-[var(--border)] overflow-hidden shadow-xs bg-[var(--surface-raised)]">
                  <Image
                ...
                <div>
                  <h3 className="text-2xl font-bold font-sans text-[var(--text-primary)]">
                    {pi.name}
                  </h3>
                  <p className="text-sm font-mono text-[var(--bio-teal)] font-semibold mt-1">
                ...
                <div className="flex flex-wrap gap-2 pt-1">
                  {pi.email && (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-mono px-3.5 py-2 rounded-xl border border-[var(--border)] bg-[var(--surface-raised)] text-[var(--text-secondary)] hover:text-[var(--bio-teal)] transition-colors"
                    >
                  ...
                  <div className="pt-4 border-t border-[var(--border)] space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {pi.interests.map((interest) => (
                        <span
                          key={interest}
                          className="px-3 py-1.5 rounded-lg text-xs border border-[var(--border)] bg-[var(--surface-raised)] text-[var(--text-secondary)] font-mono"
                        >
                          {interest}
                        </span>
                      ))}
