...
export function ResearchPillars() {
  return (
    <section className="w-full bg-[var(--surface)] py-8 sm:py-16 lg:py-24 border-b border-[var(--border)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 space-y-6 sm:space-y-12">
        ...
        {/* 4 Clean, Scaled Pillar Cards (Space-Optimized for Mobile) */}
            ...
            >
              ...
              <div className="relative aspect-[2.2/1] sm:aspect-[16/10] w-full overflow-hidden bg-[var(--surface-raised)]">
                ...
                <div className="absolute top-2.5 left-2.5 sm:top-3 sm:left-3">
                  <span className="text-[10px] sm:text-[11px] font-mono font-medium px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md bg-[var(--surface)]/95 backdrop-blur-md text-[var(--text-secondary)] border border-[var(--border)] shadow-xs">
                    {pillar.tag}
                  </span>
                </div>
              </div>
              ...
              <div className="p-3.5 sm:p-6 flex-1 flex flex-col justify-between space-y-3 sm:space-y-4">
                ...
                <div className="pt-2.5 sm:pt-4 border-t border-[var(--border)] flex items-center justify-between text-xs font-mono font-medium text-[var(--text-muted)]">
